...
begin
  ...
  TreeView1.Items.AddChild(TreeView1.Items.GetLastNode,IntToStr(TreeView1.Items.GetLastNode.Index+1)+' Folder');
    TreeView1.Items.AddChild(TreeView1.Items.GetLastNode,'Folder');
    TreeView1.Items.AddChild(TreeView1.Items.GetLastSubNode, 'Subfolder');
    TreeView1.Items.AddChild(TreeView1.Items.GetLastNode,IntToStr(TreeView1.Items.GetLastSubNode.Index+1)+' Folder');
